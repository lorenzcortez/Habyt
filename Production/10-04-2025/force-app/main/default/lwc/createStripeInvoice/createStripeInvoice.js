...
import createInvoice from '@salesforce/apex/CreateStripeInvoiceController.createInvoice';
import { CloseActionScreenEvent } from 'lightning/actions';

export default class CreateStripeInvoice extends LightningElement {
    _recordId;
    invoiceTypeValue = '';
    ...
    handleCreateInvoice(event){
        ...
        if (allComboValid && allValidItems && allValidYear) {
            ...
            if(proceed){
                ...
                createInvoice({jsonBody : JSON.stringify(invoiceData)})
                .then(result => {
                    let title = '',
                        message = '',
                        variant = '';
